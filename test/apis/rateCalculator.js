        ...
        test.deepEqual(
          ...
          { package:
             [ { zipOrigination: '44106',
                 ...
                 machinable: 'TRUE',
                 zone: '3',
                 postage: { mailService: 'First-Class Mail&lt;sup&gt;&#174;&lt;/sup&gt; Stamped Letter',
                            rate: '1.15',
                            specialServices:
                             { specialService:
                                [ { serviceID: '104',
                                    ...
                                    price: '1.35' },
                                  { serviceID: '160',
                                    serviceName: 'Certificate of Mailing (Form 3665)',
                                    available: 'true',
                                    price: '0.38' },
                                  { serviceID: '105',
                                    ...
                                    price: '3.45' },
                                  { serviceID: '170',
                                    serviceName: 'Certified Mail&lt;sup&gt;&#174;&lt;/sup&gt; Restricted Delivery',
                                    available: 'true',
                                    price: '8.60' },
                                  { serviceID: '171',
                                    serviceName: 'Certified Mail&lt;sup&gt;&#174;&lt;/sup&gt; Adult Signature Required',
                                    available: 'true',
                                    price: '8.60' },
                                  { serviceID: '172',
                                    serviceName: 'Certified Mail&lt;sup&gt;&#174;&lt;/sup&gt; Adult Signature Restricted Delivery',
                                    available: 'true',
                                    price: '8.60' },
                                  { serviceID: '103',
                                  ...
                                  { serviceID: '175',
                                    serviceName: 'Collect on Delivery Restricted Delivery',
                                    available: 'true',
                                    price: '12.40',
                                    declaredValueRequired: 'true',
                                    dueSenderRequired: 'false' },
                                  { serviceID: '100',
                                    ...
                                    dueSenderRequired: 'false' },
                                  { serviceID: '177',
                                    serviceName: 'Insurance Restricted Delivery',
                                    available: 'true',
                                    price: '14.60',
                                    declaredValueRequired: 'true',
                                    dueSenderRequired: 'false' },
                                  { serviceID: '109',
                                    ...
                                    dueSenderRequired: 'false' },
                                  { serviceID: '176',
                                    serviceName: 'Registered Mail&lt;sup&gt;&#8482;&lt;/sup&gt; Restricted Delivery',
                                    available: 'true',
                                    price: '17.35',
                                    declaredValueRequired: 'true',
                                    dueSenderRequired: 'false' } ] } } },
               { zipOrigination: '44106',
                 ...
                 size: 'LARGE',
                 zone: '3',
                 postage: { mailService: 'Priority Mail 2-Day&lt;sup&gt;&#8482;&lt;/sup&gt;',
                            rate: '19.90',
                            commitmentDate: moment().add(moment().day() === 2 ? 6 : 5, 'day').format('YYYY-MM-DD'),
                              ...
                              { specialService:
                                [ { serviceID: '119',
                                  ...
                                  { serviceID: '155',
                                    ...
                                    available: 'true',
                                    price: '0.0' } ] } } },
               { error: { number: '-2147219421',
                          source: 'RateEngineV4;RateV4.ProcessRequest',
                          description: 'Ship Date must be within the next three days.',
                          helpFile: '',
                          helpContext: '' } } ] },
    ...
    usps.rateCalculator.intlRate(
      ...
      function (error, response) {
        ...
        test.deepEqual(
          response,
          { package:
             [ { error: { number: '-2147219037',
                          source: ';IntlRateV2.ProcessRequest',
                          description: "AcceptanceDateTime cannot be earlier than today's date.",
                          helpFile: '',
                          helpContext: '' } },
               { prohibitions: 'Articles made of tortoise-shell, mother of pearl, ivory, bone meerschaum and amber (succin), natural or reconstructed, worked jade and mineral substances similar to jade.\nCanned vegetables, fish, plums and nuts.\nFuneral urns.\nHousehold articles made of tin.\nPerishable infectious biological substances.\nPerishable noninfectious biological substances.\nPictures and printed matter of pornographic or immoral nature, or which tend to incite crime or juvenile delinquency.\nRadioactive materials.\nSaccharine in tablets or packets.\nUsed clothing, accessories, blankets, linen, textile furnishings, footwear and headwear.\nWatches and clocks.',
                 restrictions: 'Articles of gold or platinum, jewelry and precious stones must be licensed by the Algerian Ministry of Finance.\nCoins, banknotes, negotiable securities, checks and other instruments of payment, may only be imported by the Central Bank of Algeria or approved intermediary banks.\nMedicines for human or veterinary use, dietetic products, serums, vaccines and similar produce; medical, surgical, and dental instruments and prostheses require prior approval from the Ministry of Public Health and subject to the visa of the Central Algerian Pharmacy.',
                 observations: 'Import permits or licenses are required for many types of goods; therefore, the sender should ascertain from the addressee before mailing whether the necessary documents are held.',
                            ...
                            extraServices:
                             { extraService:
                                { serviceID: '6',
                                  ...
                                  available: 'True',
                                  price: '1.35' } },
                            valueOfContents: '75.00',
                            insComment: 'SERVICE',
                            svcCommitments: 'Varies by destination',
                            svcDescription: 'First-Class Mail&lt;sup&gt;&#174;&lt;/sup&gt; International Letter',
                            maxDimensions: 'Max. length 11-1/2", height 6-1/8" or thickness 1/4"',
                            maxWeight: '.22' } } ] },
